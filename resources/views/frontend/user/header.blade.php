    ...
    <div id="wrapper" style="background-color:#4a494a;">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".sidebar-collapse" style="background-color:#f37553;">
				...
				<a class="navbar-brand" href="index.html"><img src="../admin/assets/img/logo.png"></a>
