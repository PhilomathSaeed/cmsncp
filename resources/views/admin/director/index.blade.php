                ...
                <div class="x_content">
                 <table width="100%" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        {!! Form::open(['method'=>'delete', 'route'=>['director.destroy', $director->id]]) !!}                        
                        <a href="{{ route('director.edit', $director->id) }}" class="btn btn-warning btn-xs" style="font-size: 12px;">Edit</a>
