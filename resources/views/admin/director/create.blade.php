@include('admin.includes.header')
   <div class="right_col" role="main">
      ...
      <div class="x_content">
      	<form method="POST" action="/administrator/director" class="form-horizontal form-label-left" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <a href="{{ route('director.index') }}" class="btn btn-primary">Cancel</a>
            </div>
          </div>
        </form>
      </div>        
