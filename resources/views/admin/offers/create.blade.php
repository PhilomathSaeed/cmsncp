          	...
          	{!! Form::open(['url'=>'administrator/offer','files' => true, 'class'=>'form-horizontal']) !!}
                ...
                <div class="row">
                     ...
                     <div class="form-group">
                        {!! Form::label('title','Offer Title', ['class'=>'control-label col-md-2']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('points','Conversion Point', ['class'=>'control-label col-md-2']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('country','Allowed Country', ['class'=>'control-label col-md-2']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('photo','Banner Image', ['class'=>'control-label col-md-2']) !!}
                         <div class="col-md-9">
